import { DataType } from "@/app/(tabs)/data";
    ...
    <GestureDetector gesture={pan}>
      <Animated.View
        ...
        <View style={styles.top}>
          <Text variant="textName">{item.name}</Text>
          <View style={styles.imageContainer}>
            <Image source={item.image} style={styles.image} />
          </View>
        </View>
        <View style={styles.middle}>
          <Text variant="textNumber">{item.number}</Text>
        </View>
        <View style={styles.bottom}>
          <View>
            <Text variant={"default"}>Valid thru</Text>
            <Text variant={"default"}>{item.exp}</Text>
          </View>
          <View>
            <Text variant={"default"}>Cvv</Text>
            <Text variant={"default"}>{item.cvv}</Text>
          </View>
        </View>
      </Animated.View>
    </GestureDetector>
